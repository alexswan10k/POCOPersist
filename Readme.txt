...
FluentCassandra for working with the Thrift API and higher level abstractions (possibly this may need to be replaced with a specific Thrift implementation at a later date)
